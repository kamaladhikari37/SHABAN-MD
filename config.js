...
BOT_NAME: process.env.BOT_NAME || "DANGER V5",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "917499190619",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "MR-SHABAN",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ Mʀ Danger*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/tasodv.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> Zinda Hun Yar *DANGER-V5*⚡",
// add alive msg here 
...
DEV: process.env.DEV || "917499190619",
